...
var actorsData: [Actor] = [
    Actor(actorname: ["a", "b"], actorpic: ["Avengers1", "Avengers1"]),
    Actor(actorname: ["a", "b"], actorpic: ["a", "b"]),
    Actor(actorname: ["a", "b"], actorpic: ["a", "b"])
]
